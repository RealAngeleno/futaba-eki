...
const S_VERIFICATION = 'Verification';                              //Describes verification field
...
const S_MOBILEBLOCK = 'Error: Mobile devices are blocked from posting';
...
const S_AUTOSAGE = 'Autosage';                                       //Defines name for autosage button
